    ...
    try {
      ...
      for (const project of projectsData) {
        await portfolioService.addProject({
          ...
          status: project.status as 'completed' | 'ongoing' | 'archived',
        ...
        <div className="flex items-center mb-4">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-green-700">
              ...
              <p className="mt-2">
                You can now refresh the page to see data loaded from Firestore.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-blue-700">
              <p>
                Click below to migrate your portfolio data from static files to
                Firestore.
              </p>
              <p className="text-xs text-blue-600 mt-1">
                This is a one-time operation that will populate your Firestore
                database.
              </p>
            </div>
          </div>
