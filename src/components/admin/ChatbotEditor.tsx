...
export default function ChatbotEditor() {
  ...
  const handleRestoreDefault = async () => {
    if (!confirm('Are you sure you want to restore the default chatbot context? This will replace your current customizations.')) return
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-8">
        ...
        <span className="ml-3 text-gray-600">Loading chatbot configuration...</span>
      </div>
    )
  }
  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex justify-between items-center mb-4">
        <div>
          <h2 className="text-xl font-semibold mb-2">AI Chatbot Configuration</h2>
          <p className="text-sm text-gray-600">
            Customize the context and instructions that the AI chatbot uses to respond to visitors.
          </p>
        </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="flex justify-between mt-2">
            <p className="text-xs text-gray-500">
              This information will be used to train the AI on how to respond to visitors' questions about you.
            </p>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <h3 className="text-sm font-semibold text-blue-800 mb-2">💡 Tips for editing the chatbot context:</h3>
          <ul className="text-sm text-blue-700 space-y-1">
            ...
            <li>• Use clear, factual language - the AI will use this directly</li>
