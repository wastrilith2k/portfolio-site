      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <p className="text-base text-gray-600 max-w-2xl mx-auto">
            Technologies and tools I work with, organized by category and
            proficiency level.
          </p>
        </div>
        ...
        <div className="mt-8 text-center">
          <div className="inline-flex items-center space-x-6 bg-blue-50 rounded-lg px-6 py-4">
            ...
            <div className="flex items-center space-x-2">
              <span
                className={`px-2 py-1 rounded-full text-xs font-medium border ${getLevelColor('advanced')}`}
              >
                Advanced
              </span>
              <span
                className={`px-2 py-1 rounded-full text-xs font-medium border ${getLevelColor('intermediate')}`}
              >
                Intermediate
              </span>
              <span
                className={`px-2 py-1 rounded-full text-xs font-medium border ${getLevelColor('beginner')}`}
              >
                Beginner
              </span>
            </div>
