...
export const projectsData = [
  {
    ...
    description:
      'AI-powered D&D Game Master application that helps players create and manage roleplaying game campaigns with intelligent storytelling.',
    technologies: [
      'React',
      'Firebase',
      'Google Gemini Pro',
  ...
  },
  {
    ...
    description:
      'React Native mobile companion app for AI-powered D&D adventures with offline support and cross-platform compatibility.',
    ...
    links: {
      repository:
        'https://github.com/wastrilith2k/solo-adventuring-with-ai-mobile',
    },
  },
  {
    id: '3',
    ...
    description:
      "Interactive web-based implementation of Conway's Game of Life cellular automaton with React and modern JavaScript.",
