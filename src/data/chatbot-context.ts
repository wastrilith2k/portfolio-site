...
export const chatbotContext = {
  personal: {
    ...
    experience:
      '6+ years specialized in React and modern frontend technologies, 15+ years total professional experience',
  },
  ...
  workExperience: [
    ...
    },
    {
      ...
      key_achievements: [
        'Microservice REST APIs development',
    ...
    },
    {
      ...
      key_achievements: [
        'React applications maintenance',
        'Cross-platform development',
        'Docker and Redis support',
      ],
    },
    {
  ...
  projects: [
    {
      ...
      description:
        'AI-powered D&D Game Master application using React, Firebase, and Google Gemini Pro for intelligent storytelling and campaign management',
      technologies: [
        'React',
        'Firebase',
        'Google Gemini Pro',
    ...
    },
    {
      ...
      description:
        'React Native mobile companion app for AI-powered D&D adventures with cross-platform compatibility',
    ...
    },
    {
      ...
      description:
        'Interactive web-based cellular automaton simulation with modern JavaScript and React',
  ...
  professionalApproach: {
    ...
    philosophy:
      'Focused on translating user requirements into efficient code while collaborating closely with designers to ensure responsive user experiences',
  },
};
...
export const getContextForTopic = (topic: string): string => {
  ...
  if (
    lowerTopic.includes('experience') ||
    lowerTopic.includes('work') ||
  ...
  if (
    ...
    lowerTopic.includes('hire') ||
    lowerTopic.includes('available')
  ) {
